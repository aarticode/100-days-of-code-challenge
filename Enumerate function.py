...
# that allows you to loop over a sequence (such as a list, tuple, or string) and get
# the index and value of each element in the sequence at the same time.
#Here's a basic example of how it works:


marks=[12,3,98,1,15,20]
index =0
for mark in marks:
    print (mark)
    if(index == 3):
...
#The enumerate function is often used when you need to loop over a sequence and perform some action with both the index and value of each element.
